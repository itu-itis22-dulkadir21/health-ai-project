# -*- coding: utf-8 -*-
"""Kaggle_UNetPlusPlus_ResNet18_Hybrid_Model_CSV.ipynb"""
...
########################################
# 2. ResNet18 Tabanlı UNet++ Modeli
########################################
...
class UNetPlusPlusResNet(nn.Module):
    def __init__(self, num_sections):
        ...
        # Decoder (Ekstra katman eklendi)
        self.up1 = self._upblock(1024, 512)
        self.up2 = self._upblock(512, 256)
        self.up3 = self._upblock(256, 128)
        self.up4 = self._upblock(128, 64)
        self.up5 = self._upblock(64, 32)
